...
const Home = () => {
  ...
  return (
    <div className="container_left container_right">
      <h2 className="section-gap__top text-center font-bold text-xl lg:text-2xl 2xl:text-4xl">Our Services</h2>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-center items-center text-center section-gap">
        {arr.map((item, i) => {
          return (
            <div className="w-full h-full min-h-[260px] gap-3 p-10 rounded-lg" key={i}>
              <div
                style={{
                  width: "100%",
                  height: "100%",
